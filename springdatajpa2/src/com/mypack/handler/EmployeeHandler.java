...
public class EmployeeHandler {
	...
	@RequestMapping("/emps")
	public String list(@RequestParam(value="pageNo",required=true,defaultValue="1")String pageNoStr,Map<String,Object> map) {
		int pageNo = 1;
		...
		Page<Employee> page = employeeService.getPage(pageNo, pageNo);
		map.put("page", page);
